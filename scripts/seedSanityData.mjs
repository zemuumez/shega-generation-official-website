...
const teamMembers = [
  ...
  },
  {
    ...
    quote: "Advancing institutional excellence and strategic alignment across all youth programs.",
    organizationAffiliations: ["Board Member", "Strategic Advisor"],
